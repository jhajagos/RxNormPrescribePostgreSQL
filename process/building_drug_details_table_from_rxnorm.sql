...
create table rxnorm_prescribe.scd_multiple_ingredients2 as 
  ...
  null as semantic_clinical_drug_component, mi.MIN_RXCUI, mi.min_RXAUI, mi.ingredients   
    ...
    join rxnorm_prescribe.scd_multiple_ingredients1 mi on rsic.scd_rxaui = mi.scd_rxaui;
...
alter table rxnorm_prescribe.scd_generic_name1 alter  scdc_rxaui type varchar(8); 
alter table rxnorm_prescribe.scd_generic_name1 alter  scdc_rxcui type varchar(8); 
alter table rxnorm_prescribe.scd_generic_name1 alter semantic_clinical_drug_component type varchar(3000); 
...
alter table rxnorm_prescribe.sbd_generic_name1 alter scdc_rxaui type varchar(8); 
alter table rxnorm_prescribe.sbd_generic_name1 alter scdc_rxcui type varchar(8); 
alter table rxnorm_prescribe.sbd_generic_name1 alter semantic_clinical_drug_component type varchar(3000); 
...
create table rxnorm_prescribe.dose_form_to_dose_form_group as
  select t.df_rxaui as dose_form_rxaui, t.dose_form, count(*) as counter, 
    string_agg(distinct dfg_rxcui, '|' order by dfg_rxcui) as synthetic_dfg_rxcui,
    string_agg(distinct dfg_rxaui, '|' order by dfg_rxaui) as synthetic_dfg_rxaui,
    string_agg(distinct dose_form_group, '|' order by dose_form_group) as synthetic_dose_form_group
...
alter table rxnorm_prescribe.drug_details alter sbd_rxaui type varchar(8);
alter table rxnorm_prescribe.drug_details alter sbd_rxcui type varchar(8);
alter table rxnorm_prescribe.drug_details alter bn_rxcui type varchar(8);
alter table rxnorm_prescribe.drug_details alter bn_rxaui type varchar(8);
alter table rxnorm_prescribe.drug_details alter brand_name type	varchar(3000);
alter table rxnorm_prescribe.drug_details alter semantic_branded_name	type varchar(3000);
...
alter table rxnorm_prescribe.ndc_drug_details alter sbd_rxaui type varchar(8);
alter table rxnorm_prescribe.ndc_drug_details alter sbd_rxcui type varchar(8);
alter table rxnorm_prescribe.ndc_drug_details alter bn_rxcui type varchar(8);
alter table rxnorm_prescribe.ndc_drug_details alter bn_rxaui type varchar(8);
alter table rxnorm_prescribe.ndc_drug_details alter brand_name type varchar(3000);
alter table rxnorm_prescribe.ndc_drug_details alter semantic_branded_name type varchar(3000);
...
create table rxnorm_prescribe.ingredient1 as
  select r1.rxaui as in_rxaui, r1.rxcui as in_rxcui, TTY, r1.str as ingredient, 
    rs1.atv as rxn_activated, rs2.ATV as rxn_obsoleted, 
    rs3.ATV as unii_code
    from rxnorm.rxnconso r1 
...
create table rxnorm_prescribe.relation_between_ingredient_component1 as
